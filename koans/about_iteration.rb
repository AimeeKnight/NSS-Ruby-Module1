...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject will set an initial value as an accumulator
  end
  ...
  #
  # The sandwich principle says that when you have two pieces of code that are
  # almost identical, except for the "middle" part, you can create a method that
  # takes a block to fill the "middle" part.
  # The technique is used in the File::open method - when you call
  # it with a block, the opened file is automatically closed after the block is
  # executed.
